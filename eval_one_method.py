...
if __name__ == '__main__':
    ...
    ir_dir = os.path.join('..\T')
    vi_dir = os.path.join('..\MRI')
    Method = 'SeAFusion'
    f_dir = os.path.join('.\\ifcnn_001_color')
    save_dir = '../Metric'
    os.makedirs(save_dir, exist_ok=True)
    # metric_save_name = os.path.join(save_dir, 'metric{}_{}.xlsx'.format(dataset_name, Method))
    metric_save_name = os.path.join(save_dir, 'l=ifcnn_001_color.xlsx'.format(dataset_name, Method))
